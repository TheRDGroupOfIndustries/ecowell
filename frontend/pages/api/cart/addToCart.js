...
import Cart from "../../../models/Cart"; // Adjust the path if necessary
import Product from '../../../models/Products'; // Import the Product model

export default async function handler(req, res) {
    const { method, body } = req;
    const { userId, productId, quantity, variant } = body; // Expecting userId, productId, quantity, and optional variant in the request body
