...
import { Button, Card, CardBody, Col, Container, Form, FormGroup, Input, Label, Modal, ModalBody, ModalFooter, ModalHeader, Row, FormFeedback } from "reactstrap";
...
const CategoriesDigital = () => {
  ...
  const [newCategory, setNewCategory] = useState<Category>({ title: "", image_link: "", slug: "" });
  ...
  const handleAddCategory = async () => {
    ...
    try {
      ...
      const response = await axios.post('/api/categories/create-category', newCategory);
      toast.success(response.data.message);
                      ...
                      <Form>
                        <FormGroup>
                          ...
                          <Input
                            ...
                            required
                          />
                          {errors.title && <FormFeedback>Category Name is required</FormFeedback>}
                        </FormGroup>
                        <FormGroup>
                          <Label className="col-form-label pt-0">Category Image</Label>
                          <Button
                            type="button"
                            color="primary"
                          ...
                          {errors.image_link && <FormFeedback className="d-block">Category Image is required</FormFeedback>}
                        </FormGroup>
                      </Form>
                    </ModalBody>
                    <ModalFooter>
